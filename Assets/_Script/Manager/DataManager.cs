...
public class DataManager : MonoBehaviour
{
    ...
    private void Start() {
        ...
        if (!hasPurchasedNoAds) {
            FindObjectOfType<AdsManager>().LoadInterstitialAndBannerAd();
        }
    ...
    private void SetDataInPlayerprefs() {
        ...
        PlayerPrefs.SetInt(userKey.key_NoAds, 0);
    ...
    private void GetDataFromPlayerPrefs() {
        ...
        if (PlayerPrefs.GetInt(userKey.key_NoAds) == 0) {
    ...
    public void SetNoAds() {
        ...
        PlayerPrefs.SetInt(userKey.key_NoAds, 1);
        hasPurchasedNoAds = true;
    }
